...
const sqlite  = require(`C:/Users/${user}/AppData/Roaming/npm/node_modules/sqlite`)
const sqlite3 = require(`C:/Users/${user}/AppData/Roaming/npm/node_modules/sqlite3`)
const dayjs   = require(`C:/Users/${user}/AppData/Roaming/npm/node_modules/dayjs`)
const _       = init()
const PORT    = 8080
...
;( async () => {
	...
	if( !fs.readdirSync("C:/test").includes("History") ){
		...
		fs.copyFileSync(`C:/Users/${user}/AppData/Local/Google/Chrome/User Data/Default/History`,
		"C:/test/History")
...
async function search(x){
	...
	tableau.sort( (a,b) => a.time - b.time )
...
function init(){
	...
	require(`C:/Users/${user}/AppData/Roaming/npm/node_modules/dayjs/locale/fr`)
	dayjs.locale("fr")
	
	return require(`C:/Users/${user}/AppData/Roaming/npm/node_modules/lodash`)
}
